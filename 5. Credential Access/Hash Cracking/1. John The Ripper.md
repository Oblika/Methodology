...
# Identifikojm dhojin e hashit per JohnTheRipper
hashid -j 'hash'

# Perdor info nga Username ose Metadata per ta thyer hashin
john --single hash

# Wordlist Mode
john --wordlist=<wordlist_file>  <hash_file>

# Provojn fjale nga WordList + Gjeneron me teper variacione
john --wordlist=<wordlist_file> --rules <hash_file>

# Single Crack Mode : use a specific hash format to crack the hash
john --format=<hash_type> <hash.txt>

# Incremental: brute force all possible combinations
john --incremental <hash_file>

# -------------- Cracking encrypted SSH keys ------------------
# Nxjerrim hashin nga nje file SSH qe eshte i enkriptuar
ssh2john.py SSH.private > ssh.hash

# Provojm ta thyejm ate hash
john --wordlist=rockyou.txt ssh.hash

#VCiew the resulting hash
john ssh.hash --show

# Nxjerrim hashin nga dokumenti, per ta thyer
office2john.py Protected.docx > protected-docx.hash

# Nxjerrim hashin nga file pdf
...
# Cracking pwsafe3 file
pwsafe2john Backup.psafe3 > hash.txt
# Hash-i nga pwsafe do perdoret si celes per dekriptimin e file
